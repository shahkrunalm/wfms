	...
	for(Message message : messageList){
		%>
			<tr>
				...
				<td width="23%"><%=message.getMsgTo()%></td>
...
<form action="./MessageController" id="SentDeleteForm" name="SentDeleteForm" method="post">
<input name="messageId" type="hidden" id="messageId" />
<input name="action" type="hidden" value="sent_delete" />
</form>
</div>
</div>
</div>
...
function deleteMessage(id){
	...
	if(cnfm){
		...
		document.getElementById("SentDeleteForm").submit();
	}
}
</script>
